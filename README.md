...
You have to design & build the backend for the application and the ability for the users to register, view, drop and add courses for different semesters.
...
https://github.com/azaylamba/onlineUniversity 
